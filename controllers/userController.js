...
exports.createUser = (req , res)=>{
  res.status(500).json({
    status: 'error',
    message: 'this route is not yet defind use /signup insted'
  })
}
...
//Do not update password with this because when we use updateByIdAndUpdate all the safe middleware is not run
